...
в нем видны строки в программе где используются данная переменная - стоит обратить внимание как на контекст/ код - так и на значение в столбце **Строка** - у нас z используется только на 13 и на 14 строке

## Первый шаг по рефакторингу

Переименовываем переменные i, j, z в 
