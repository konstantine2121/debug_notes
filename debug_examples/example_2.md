...
Для этого нам необходимо установить в нужных местах точки останова с особыми настройками - нажать галочку "Действия" - станет доступна опция "Gjrfpfnm cjj,otybt d j"
